...
python3.10 run.py policy=rc_calfq initial_conditions=3wrobot_kin system=3wrobot_kin common.sampling_time=0.1 simulator.time_final=20 --interactive --fps=10 --jobs=1
